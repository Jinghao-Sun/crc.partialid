...
``` {r}
# CITIB = ci.tib(Polish, restriction_type = "highest", gamma = 0.1, alpha = 0.05, B = 500,lb = 0.5, ub = 60, tol = 1e-3, search_step = 30, tasks = 2, verbose = TRUE)

CIPL = ci.pl(Polish, restriction_type = "highest", gamma = log(2), lb = 0.05, ub = 60, tol = 1e-3, xtol_rel = 1e-3, maxeval = 300, verbose = TRUE)
```
